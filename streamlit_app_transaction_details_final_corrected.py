...
# Save the file again with the correct syntax
output_path_fixed = "/mnt/data/streamlit_app_transaction_details_final_corrected.py"
with open(output_path_fixed, "w") as f:
